...
/*   Updated: 2025/11/28 13:43:45 by almighty         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
inline void	reset_line_output(t_line *line, int term_cols, t_gl *env)
{
	size_t	index;
	size_t	i;
...
inline void	show_line_output(t_line *line, int term_cols, t_gl *env)
{
	size_t	i;
