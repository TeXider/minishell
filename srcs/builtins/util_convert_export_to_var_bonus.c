...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   util_convert_export_to_var_bonus.c                 :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: tpanou-d <tpanou-d@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/11/21 10:48:16 by almighty          #+#    #+#             */
/*   Updated: 2026/01/16 15:01:37 by tpanou-d         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static inline size_t	compute_var_len(char *exp, t_var_info *var_info,
	t_env *env)
{
	size_t	name_len;
	size_t	var_len;
	...
	name_len = 0;
	while (is_var_char(exp[name_len]))
		name_len++;
	var_len = name_len;
	...
	t_var_info *var_info, t_env *env)
{
	...
	if (safe_challoc(var_dst, compute_var_len(exp, var_info, env), env))
		return (true);
